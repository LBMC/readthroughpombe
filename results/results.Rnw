...
\author{Claire Burny, Clémence Hocquet, Xavier Robellet, Laurent Modolo, Pascal Bernard}
\maketitle
\tableofcontents
\newpage
...
\includegraphics{{quality_control/fastqc_per_sequence_gc_content_plot}.png}\\
\includegraphics{{quality_control/fastqc_overrepresented_sequencesi_plot}.png}


% ------------------------
\subsection{Data cleaning}

We used cutadapt to trim tails with quality lower than 20. No other filter was applied.
...
% ------------------------------------------------------------------
\subsection{Mapping to S. pombe reference genome and quantification}

This was done using mapping.nf on PSMN. This was done by coupling Bowtie2 and RSEM. It gives:

\begin{tabular}{c|c|c|c|c}
sample & aligned concordantly 0 times & exactly 1 time & > 1 time & \% mapped\\
\hline
1 - wt repl1 & 50,615,390 (85.30\%) & 8,159,838 (13.75\%) & 565,734 (0.95\%) & 14.7\%\\
6 - wt repl2 & 62,951,979 (85.58\%) & 9,885,080 (13.44\%)  & 719,417 (0.98\%) & 14.42\%\\
11 - wt repl3 & 60,820,577 (85.23\%) & 9,839,256 (13.79\%) & 702,417 (0.98\%) & 14.77\%\\
\hline
2 - cut14-208 repl1 & 64,182,487 (90.35\%) & 6,434,090 (9.06\%) & 418,747 (0.59\%)  & 9.65\%\\
7 - cut14-208 repl2 & 68,386,532 (84.90\%) & 11,448,221 (14.21\%) & 711,815 (0.88\%) & 15.10\%\\
12 - cut14-208 repl3 &  68,005,802 (84.83\%) & 11,448,867 (14.28\%) & 715,365 (0.89\%) & 15.17\%\\
\hline
3 - cut14-208  cdc15-118 repl1 & 67,642,419 (85.64\%) & 10,626,744 (13.45\%) & 715,568 (0.91\%) & 14.36\%\\
8 - cut14-208  cdc15-118 repl2 & 61,630,532 (85.36\%) &  9,925,891 (13.75\%) & 644,385 (0.89\%) & 14.64\%\\
13 - cut14-208  cdc15-118 repl3 &  71,964,476 (85.43\%) & 11,570,117 (13.73\%) & 705,923 (0.84\%) & 14.57\%\\
\hline
4 - cdc15-118 repl1 & 70,904,425 (91.07\%) & 6,451,721 (8.29\%) &   503,667 (0.65\%)& 8.93\%\\
9 - cdc15-118 repl2 & 63,009,528 (87.66\%) & 826,0981 (11.49\%) & 609,730 (0.85\%) & 12.34\%\\
14 - cdc15-118 repl3 &  73,149,383 (85.39\%) & 11,672,915 (13.63\%) & 838,913 (0.98\%)& 14.61\%\\
\hline
5 - rrp6D repl1 & 64,510,957 (83.99\%) & 11,626,695 (15.14\%) & 672,129 (0.88\%)  & 16.01\%\\
10 - rrp6D repl2 & 79,218,230 (84.85\%) & 13,245,925 (14.19\%) & 899,484 (0.96\%) & 15.15\%\\
15 - rrp6D repl3 & 71,484,515 (91.31\%) & 6,372,959 (8.14\%) & 430,835 (0.55\%) & 8.69\%\\
\end{tabular}

\textcolor{red}{These needed to be updated according to PSMN crash.}


% ---------------------------------------
\subsection{Assessment of unmapped reads}

(For the most unmapped sample, I suggest to map against rRNA/tRNA)
...
Each time, conditions are in triplicates.
...
\begin{itemize}
  \item Validate on what we work for RNASeq (not clear for ncRNA and tRNA)
  \item Do RNASeq analysis with adding missing replicates.
  \item Validate comparisons to be done with rrp2 mutant.
