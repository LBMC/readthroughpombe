...
module load nextflow/0.25.1
nextflow src/pipeline.nf -c src/pipeline.config -profile sge --fastq "results/quality_control/trimming/*.fastq.gz" --fasta "data/2017_10_26_Schizosaccharomyces_pombe.ASM294v2.30.dna.genome.fasta.gz" --annot '../../data/readthroughpombe/data/2017_09_19_schizosaccharomyces_pombe.chr.gtf' --todo "bowtie2+rsem" -w /scratch/lmodolo/readthroughpombe/work/ -resume
