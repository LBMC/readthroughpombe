...
bin/nextflow src/pipe/quality_control.nf --fastq_files 'data/examples/tiny_dataset/fastq/*tiny_S.fastq.gz' --trimmer 'UrQt' --paired true -c src/nextflow.config -with-docker quality_control:0.0.1
