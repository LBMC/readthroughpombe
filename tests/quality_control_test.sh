...
bin/nextflow src/pipe/quality_control.nf --fastq_files 'data/examples/*_R{1,2}.fastq.gz' --trimmer 'UrQt' --paired true -resume -c src/nextflow.config --with-docker 'src/Dockerfile'
