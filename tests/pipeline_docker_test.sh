...
bin/nextflow src/pipeline.nf -c src/pipeline.config -profile docker --fastq "data/examples/tiny_dataset/fastq/*tiny_R{1,2}.fastq" --index "results/mapping/indexing/2017_10_16_tiny_v2.index*" --annot "data/examples/tiny_dataset/annot/tiny.gff" --todo "bowtie2+rsem" && \
bin/nextflow src/pipeline.nf -c src/pipeline.config -profile docker --fastq "data/examples/tiny_dataset/fastq/*tiny_R{1,2}.fastq" --index "results/mapping/indexing/2017_10_16_tiny_v2_split.index*" --annot "data/examples/tiny_dataset/annot/tiny.gff" --todo "kallisto"
